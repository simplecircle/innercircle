...
ActiveRecord::Schema.define(version: 20131028221104) do
  ...
  add_index "posts", ["provider_publication_date"], name: "index_posts_on_provider_publication_date", using: :btree
  add_index "posts", ["provider_uid"], name: "index_posts_on_provider_uid", using: :btree
  ...
  create_table "users_company_depts", force: true do |t|
    t.integer  "user_id"
  ...
  add_index "users_company_depts", ["company_dept_id"], name: "index_profiles_company_depts_on_company_dept_id", using: :btree
  add_index "users_company_depts", ["user_id"], name: "index_profiles_company_depts_on_profile_id", using: :btree
